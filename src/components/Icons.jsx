...
// ============================================================
// ИКОНКИ КАТЕГОРИЙ — единый стиль
// ============================================================

export function IconShooting({ size = 22 }) {
  return (
...
export function IconDribbling({ size = 22 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
      stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconDrives({ size = 22 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
      stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M3 12H17" />
...
export function IconFinishing({ size = 22 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
      stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M5 4V10" />
...
export function IconAthleticism({ size = 22 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
      stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M6 12H18" />
...
export function IconIQ({ size = 22 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
      stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M9 18C9 18 9 16 9 15C9 14 7 13 7 10C7 6.7 9.2 4 12 4C14.8 4 17 6.7 17 10C17 13 15 14 15 15C15 16 15 18 15 18" />
...
export function IconDefense({ size = 22 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
      stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconPassing({ size = 22 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
      stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
// ============================================================
// ИКОНКИ РЕЖИМОВ / МИКСА
// ============================================================

export function IconRobot({ size = 24 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
      stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconMoon({ size = 24 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
      stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconFire({ size = 22 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
      stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 22C16 22 19 19 19 15C19 11 16 8 14 5C13 8 11 9 10 7C9 10 7 11 6 13C5 15 5 17 6 19C7 20 8 21 9 21C8 19 9 17 10 17C11 17 11 19 10 21C10.6 21.7 11.3 22 12 22Z" />
    </svg>
  )
}

export function IconCooldown({ size = 22 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
      stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export function IconTrophy({ size = 24 }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none"
      ...
      <path d="M7 6H4V7C4 9.2 5.8 11 8 11" />
      <path d="M17 6H20V7C20 9.2 18.2 11 16 11" />
      <path d="M12 14V18" />
      <path d="M9 21H15" />
      <path d="M10 18H14V21H10Z" />
    </svg>
  )
}
...
// ========== ИКОНКИ ЦЕЛЕЙ (для настроек тренировок) ==========
